...
/**
 * Configures {@link NgxControlErrorDirective}.
 */
...
/**
 * Represents the context of the template the {@link NgxControlErrorDirective} sits on.
 */
export interface NgxControlErrorContext {
  /**
   * Reference to the `errors` of {@link NgxControlErrorDirective.control}
   */
  $implicit: ValidationErrors;

  /**
   * Reference to {@link NgxControlErrorDirective.control}
   */
  control: AbstractControl;

  /**
   * Reference to {@link NgxControlErrorDirective.track}
   */
  track: string | string[];
}
...
export class NgxControlErrorDirective {
  ...
  public static ngTemplateContextGuard = (
    directive: NgxControlErrorDirective,
    context: unknown
